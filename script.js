...
watchAdBtn.addEventListener("click", function () {
    ...
    // ============================================================
    // REWARDED AD HOOK — this is a placeholder for now.
    // Once you're approved for Google H5 Games Ads, replace the
    // alert() below with a call to adConfig()/adBreak() and only
    // give the reward inside the "viewed" callback, e.g.:
    //
    //   adBreak({
    //     type: 'reward',
    //     name: 'extra_hearts',
